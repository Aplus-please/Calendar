...
//	public ApptStorageControllerImpl(){
//	mApptStorage = new ApptStorage();
//	}
	...
	//get the next valid Appt id
	public int getusableid(){
		return mApptStorage.getusableid();
	}
	
    //set locationlist
	public void setlocation(String location){
		mApptStorage.setlocationlist(location);

	}
	
	public String getusername(){
		return mApptStorage.getusername();
		}

	public Boolean timecrash(String username, TimeSpan time) {
		return mApptStorage.timecrash(username, time);
	}
	
	public void testing() {
		mApptStorage.testing();
	}
}
