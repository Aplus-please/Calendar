...
public class SignUpDialog extends JFrame implements ActionListener
{
	...
	public SignUpDialog()		// Create a dialog to log in
	{
		...
		setTitle("Become a good time management person");
		...
		messPanel.add(new JLabel("Sign up with a new name and password"));
		top.add(messPanel);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == button)
		{
			...
			String Userpw = String.valueOf(password.getPassword());	
			User user = new User( userName.getText(), Userpw);
			setVisible( false );
		}
