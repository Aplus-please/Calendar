...
public class CalGrid extends JFrame implements ActionListener {
	...
	public CalGrid(ApptStorageControllerImpl con) {
		...
		getDateArray(data); //排列date in a month to array
	...
	public void getDateArray(Object[][] data) {
		...
		Date d = c.getTime();
		c.setTime(d);
		day = d.getDay(); //0 = Sunday, 1 = Monday, 2 = Tuesday, 3 = Wednesday, 4 = Thursday, 5 = Friday, 6 = Saturday
		date = d.getDate(); //1-31 
//day=0,date=10,temp=
		...
		ActionListener listener = new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (e.getActionCommand().equals("Manage Location")) {
					LocationsDialog b = new LocationsDialog("New",CalGrid.this);
